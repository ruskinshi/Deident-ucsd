        ...
        if num >= 0:
            ...
            for i in range(num):
                ...
                if patid in df2['CAP ID'].values:
                    ...
                    df2.loc[len(df2)] = [patid,' ',' ',' ',' ',' ',' ','To Be Assigned',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ']
    ...
    def accept(self):
        ...
        for x in d:
            ...
            for idx,j in enumerate(d[x]):
                ...
                df1.to_excel(copy,'Sheet1')
                df2.to_excel(copy,'Sheet2')
                copy.save()
                ...
                df1.loc[len(df1)] = [ID,'X',name,patientid,d2,'',d1,'','',ID,'','',age,sex,'',doctor,location,'','']
